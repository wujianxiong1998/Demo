...
function createklinedata(resolutioninfo, timestamp, from, to){
    ...
    obj = {
        ...
        open: parseFloat((Math.random() * 2 + i + 9700).toFixed(4)),
        close: parseFloat((Math.random() * 2 + i + 9700).toFixed(4)),
        high: parseFloat((Math.random() * 2 + i + 9700).toFixed(4)),
        low: parseFloat((Math.random() * 2 + i + 9700).toFixed(4)),
        volume: parseFloat((Math.random() * 1000).toFixed(4)),
        time: timestamp * 1000,
        isEnd: false,
